...
const AdminCategory = ()=>{
   ...
   const linkStyle={
    ...
    <tr>
        ...
        <td className="uneditable"><span> <Link to={`/admin/categories/updateCategory/${cate.id}`} style={linkStyle}><i class="fa fa-edit"></i></Link>
            <i className="fa fa-times-circle" onClick={()=>deleteCategory(cate.id)}></i>
            </span></td>
    </tr>
    );
                    ...
                    <div>
                        <div className="row w3-res-tb">
                            ...
                            <div className="col-sm-4 m-b-xs">
                                <Link to="/admin/categories/addCategory"><button className="btn btn-sm btn-default">Thêm<i class="fa fa-plus"></i></button></Link>
                            </div>
                        </div>
