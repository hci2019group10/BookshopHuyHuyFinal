...
const AdminAuthor = ()=>{
   ...
   const linkStyle={
    ...
    <tr>
        ...
        <td className="uneditable"><span> <Link to={`/admin/authors/updateAuthor/${au.id}`} style={linkStyle}><i class="fa fa-edit"></i></Link>
            <i className="fa fa-times-circle" onClick={()=>deleteAuthor(au.id)}></i>
            </span></td>
    </tr>
    );
                    ...
                    <div>
                        <div className="row w3-res-tb">
                            ...
                            <div className="col-sm-4 m-b-xs">
                                <Link to="/admin/authors/addAuthor"><button className="btn btn-sm btn-default">Thêm<i class="fa fa-plus"></i></button></Link>
                            </div>
                        </div>
