...
const AdminAddProduct = ()=>{
   ...
   const schema = yup.object().shape({
    ...
    const bgDefault = {
        backgroundImage: "url(https://res.cloudinary.com/tanhuy/image/upload/v1629957333/tanhuy/product_default_y8sgbi.png)"
    }
    //form style
    const formStyle = {
        width : "100%"
    ...
    const onSubmit = async data  => {
        ...
        const productDetailBody = JSON.stringify({
          ...
          const response1 = await customFetch(URLAddProductDetail, "POST", productDetailBody);
    ...
    return(
        <div id="main-content">
            <h3 className="product_detail">Thêm sản phẩm</h3>
            <div className="row ">
                                ...
                                <div className="profile-form-info">
                                        <div className="mb-3 row">
                                            ...
                                            <div className="col-sm-10">
                                                <input {...register("productname")} type="text" className="form-control" id="productName" />
                                        ...
                                        <div className="mb-3 row">
                                            ...
                                            <div className="col-sm-4">
                                                <input {...register("productprice")} type="text" className="form-control" id="productPrice"/>
                                        ...
                                        <div className="mb-3 row">
                                            ...
                                            <div className="col-sm-4">
                                                <select {...register("author")} className="form-control" id="author">
                                            ...
                                            <div className="col-sm-4">
                                                <select {...register("publisher")} className="form-control" id="publisher">
                                        ...
                                        <div className="mb-3 row">
                                            ...
                                            <div className="col-sm-4">
                                                <input {...register("language")} type="text" className="form-control" id="language" />
                                                <p style={style}>{errors.language?.message}</p>
                                            </div>
                                            <label htmlFor="format" className="col-sm-2 col-form-label">Định dạng:</label>
                                            <div className="col-sm-4">
                                                <input {...register("format")} type="text" className="form-control" id="format" />
                                        ...
                                        <div className="mb-3 row">
                                            ...
                                            <div className="col-sm-4">
                                                <input {...register("dimension")} type="text" className="form-control" id="dimention" />
                                            </div>
                                            <label htmlFor="country" className="col-sm-2 col-form-label" >Quốc gia:</label>
                                            <div className="col-sm-4">
                                                <input {...register("country")} type="text" className="form-control" id="country"/>
                                            </div>
                                        </div>
                                        <div className="mb-3 row">
                                            <label htmlFor="code" className="col-sm-2 col-form-label obligate">Code:</label>
                                            <div className="col-sm-4">
                                                <input {...register("code")} type="text" className="form-control" id="code" />
                                            ...
                                            <div className="col-sm-4">
                                                <input {...register("dateRealese")} type="date" className="form-control" id="dateRelease"/>
                                            </div>
                                        </div>
                                        <div className="mb-3 row">
                                            <label htmlFor="quantity" className="col-sm-2 col-form-label obligate">Số lượng:</label>
                                            <div className="col-sm-4">
                                                <input {...register("quantity")} type="text" className="form-control" id="quantity"/>
                                            ...
                                            <div className="col-sm-4">
                                                <input {...register("promotion")} type="text" className="form-control" id="promotion" />
                                        ...
                                        <div className="mb-3 row">
                                            ...
                                            <div className="col-sm-10">
                                                <textarea {...register("discription")} className="form-control" rows="5"/>
                                            </div>
                                        </div>
